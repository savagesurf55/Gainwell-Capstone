...
int main() {
    ...
    FILE *csv_file = fopen("CSV Files/TestResults.csv", "r");
    if (!csv_file) {
        fprintf(stderr, "Error opening file: CSV Files/TestResults.csv\n");
        exit(EXIT_FAILURE);
    }
    ...
    while (fgets(line, sizeof(line), csv_file)) {
        ...
        // Insert the test result data into the TestResults table
