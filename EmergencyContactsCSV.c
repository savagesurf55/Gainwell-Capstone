...
int main() {
    ...
    FILE *csv_file = fopen("CSV Files/EmergencyContacts.csv", "r");
    if (!csv_file) {
        fprintf(stderr, "Error opening file: CSV Files/EmergencyContacts.csv\n");
        exit(EXIT_FAILURE);
    }
    ...
    while (fgets(line, sizeof(line), csv_file)) {
        ...
        // Insert the emergency contact data into the EmergencyContact table
